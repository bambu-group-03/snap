...
import CommentButton from './components/card/comment-button';
import HeartButton from './components/card/heart-button';
import ResnapButton from './components/card/re-snap-button';
